    ...
    <div class="container container--with-sidebar">
        <header class="main-header">
            ...
            <div class="main-header__side">
                <a class="main-header__side-item button button--plus open-modal" href="templates/form-task.php">Добавить задачу</a>
...
<footer class="main-footer">
    <div class="container">
        ...
        <a class="main-footer__button button button--plus" href="templates/form-task.php">Добавить задачу</a>
